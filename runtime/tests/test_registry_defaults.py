...
def test_default_defaults_loaded_from_package_data() -> None:
    ...
    assert defaults["assembler"] == "assembler"
...
""",
    ...
    assert merged["assembler"] == "assembler"
...
""",
    ...
    assert registry.default_for("assembler") == "assembler"
...
def test_agent_defaults_accessors_use_single_source_of_truth() -> None:
    ...
    assert default_assembler_id() == "assembler"
