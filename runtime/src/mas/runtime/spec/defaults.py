...
from mas.runtime.spec.schema_defaults_generated import (
    CONTEXT_MANAGER_HYSTERESIS_RATIO,
    CONTEXT_MANAGER_KEEP_TURNS,
...
DEFAULT_KEEP_TURNS = CONTEXT_MANAGER_KEEP_TURNS
DEFAULT_HYSTERESIS_RATIO = CONTEXT_MANAGER_HYSTERESIS_RATIO
