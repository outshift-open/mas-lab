...
Uses python-frontmatter library with lenient YAML fallback for malformed
frontmatter (e.g. unquoted values containing colons).
"""
...
def parse_skill_frontmatter(text: str) -> tuple[dict, str]:
    ...
    - Malformed YAML (e.g. unquoted values containing colons): falls back to
      quoting suspicious values before retrying
