...
class GetFaresTool(ToolContract):
        ...
        return [
            {
                ...
                "parameters": {
                    ...
                    "properties": {
                        "route_id": {
                            "type": "string",
                            "description": "Route identifier from the network (e.g. 'CV', 'CF-train', 'CL-air'). Must match exactly — use query_graph_database to discover valid IDs. NOT a city abbreviation.",
                        },
                        "travel_class": {
                            "type": "string",
