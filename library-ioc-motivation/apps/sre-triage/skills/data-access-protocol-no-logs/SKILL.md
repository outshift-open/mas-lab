---
name: data-access-protocol-no-logs
description: >
  Tool invocation discipline for all data-access tools (get_metrics,,
...
When calling any data tool (`get_metrics`, `get_service_health`,
