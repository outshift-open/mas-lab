---
name: deployment-investigation-no-sol
description: >
...
## Rollback Decision Tree (is a solution is required)

- Deploy < 30 min ago AND P99 spike started within 5 min of deploy → **ROLLBACK**.
